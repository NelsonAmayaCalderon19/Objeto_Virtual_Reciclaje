...
<br/>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <br>
<form action="Control_Rector?menu=Rector" method="POST" id="miForm2" name="mi_formulario" onSubmit="return validar_campos()">

  <div class="form-group">
    <label for="Usuario">Usuario</label>
    <input type="text" class="form-control" id="usuario" name="txtuser"  placeholder="Ingresa tu Usuario">
  </div>
  
  <div class="form-group">
    <label for="contrseña">Contraseña</label>
    <input type="password" class="form-control" id="password" name="txtpass"  placeholder="Ingresa tu Contraseña">
  </div>
  ...
  <br>
<form action="Control_Docente" method="POST" id="miForm3" name="mi_form" onSubmit="return validar()">

  <div class="form-group">
    <label for="Usuario">N° Cedula ó Código</label>
    <input type="text" class="form-control" id="cedula" name="txtcedula" placeholder="Ingresa tu N° de Cedula o Código">
  </div>
  
  <div class="form-group">
    <label for="contrseña">Contraseña</label>
    <input type="password" class="form-control" name="txtpass" id="password" placeholder="Ingresa tu Contraseña">
  </div>
  ...
  <script src="js/admin_loginjs.js" type="text/javascript"></script>
    </body>
</html>
