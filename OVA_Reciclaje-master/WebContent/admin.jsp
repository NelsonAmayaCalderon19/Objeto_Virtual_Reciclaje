...
<script src="https://cdn.jsdelivr.net/npm/alertifyjs@1.11.0/build/alertify.min.js"></script>
  ...
  <form  action="Control_Rector?menu=Rector" method="POST">
                    ...
                    <%while(rs.next()){%>
                        <tr>                            
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning" href="#"><span class="fa fa-pencil-square-o" style="color: white;"></span></a>
                           <a class="btn btn-danger" href="javascript:;" onclick="aviso('Control_Rector?menu=Rector&accion=delete&id=<%=rs.getString("id")%>'); return false;"><span class="fa fa-minus-circle" style="color: white;"></span></a></td>
                        </tr>
                       <%}%>                       
                </tbody>
            </table> 
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
      <form action="Control_Rector?menu=Rector" method="POST" id="miForm"> 
