...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2020 a las 23:52:56
...
INSERT INTO `admin` (`Usuario`, `Contraseña`, `id_Colegio`) VALUES
('col_julio', 'julio12345', 2),
('col_luis', 'luis12345', 1);
...
INSERT INTO `alumno` (`identificacion`, `nombre`, `id_tipo`, `id_Colegio`, `fecha`) VALUES
('1093798043', 'Nelson Amaya', 2, 1, '2020-04-25 19:33:50'),
('1293934734', 'Andres Rojas', 2, 2, '2020-04-26 09:47:46'),
('21454654854', 'Nelson Amaya', 2, 4, '2020-04-27 16:21:35'),
('23442334', 'Jose Orozco', 1, 1, '2020-04-25 20:19:00'),
('3435345345', 'Andres Duran', 1, 3, '2020-04-29 21:47:52'),
('3454365', 'Fercho Ortiz', 1, 2, '2020-04-26 09:51:08'),
('3534534534', 'Nelson Caicedo', 2, 1, '2020-05-01 10:16:23'),
('353465436', 'Daniel Andrade', 1, 1, '2020-04-29 21:35:12'),
('3544326432', 'Pedro Arias', 1, 3, '2020-04-25 20:08:31'),
('3673673', 'Alfredo Hurtado', 1, 3, '2020-05-28 12:50:48'),
('423142314123', 'Alberto Diaz', 1, 4, '2020-04-29 21:25:10'),
('4234123324', 'Stella Calderon', 2, 1, '2020-04-25 20:16:05'),
('4325435342', 'Amparo', 1, 2, '2020-04-29 21:39:30'),
('433252345', 'Antonio Cervantes', 1, 2, '2020-04-29 21:41:03'),
('4341324', 'Fercho Pedraza', 1, 3, '2020-04-29 21:26:43'),
('4362432645', 'Jaider Amaya', 1, 4, '2020-04-26 09:52:57'),
('53532562', 'Adriana Rojas', 2, 2, '2020-04-26 09:49:23'),
('535435432534', 'Ana Navarro', 1, 1, '2020-04-29 21:42:36'),
('53643643', 'Jose Padilla', 1, 4, '2020-04-26 09:56:03'),
('537374656', 'Carlos Blanco', 1, 3, '2020-04-26 09:54:56'),
('543524534', 'Ana Castillo', 2, 3, '2020-04-26 09:56:58'),
('56464364', 'Pedro Camaño', 1, 2, '2020-04-29 21:45:49'),
('65464564554', 'Estaquia Ordoñez', 1, 1, '2020-04-29 21:44:23'),
('6546456456', 'Joselito Uruquijo', 1, 2, '2020-04-29 21:37:52'),
('65465373', 'Geovanny Calderon', 2, 3, '2020-04-26 09:48:32');
...
INSERT INTO `docente` (`id`, `nombre`, `cedula`, `codigo`, `email`, `contraseña`, `id_Colegio`) VALUES
(1, 'Carmen Parada', '83847374', '122738', 'carmenpc@ufps.edu.co', '12345', 1),
(2, 'Ana Barreto', '376245726', '2152415', 'anabarreto@hotmail.com', 'ana12345', 1),
(7, 'Nelson Amaya', '472384629', '326472', 'nelsonamayacalderon@gmail.com', 'amaya12345', 1),
(8, 'Jose Arias', '6482334423', '4526674', 'josearias@gmail.com', 'joselito123', 2),
(9, 'Pedro Diaz', '453453434', '23232', 'pedro@gmail.com', 'pedro12345', 1);
...
(2, 17, 'Opción A', 0, 'Opción B', 0, 'Opción C', 1, 'Opción D', 0);
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`id_Colegio`) REFERENCES `colegio` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `alumno`
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `alumno_ibfk_1` FOREIGN KEY (`id_Colegio`) REFERENCES `colegio` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `docente`
  ADD CONSTRAINT `fk_col` FOREIGN KEY (`id_Colegio`) REFERENCES `colegio` (`id`) ON UPDATE CASCADE;
